    ...
    <section className="relative py-12 sm:py-16 lg:py-20 px-4 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        {settings.visibility.homeStats && (
          ...
          >
            {[
              { label: 'ผู้ใช้งาน', value: Math.max(2031, members.length + 2031).toLocaleString('th-TH'), icon: Users, color: 'text-blue-400', bg: 'bg-blue-500/10 border-blue-500/20', glow: '' },
              ...
              { label: 'คำสั่งซื้อ', value: Math.max(401, orders.length + 401).toString(), icon: Package, color: 'text-amber-400', bg: 'bg-amber-500/10 border-amber-500/20', glow: '' },
